<template>
  <div id="userInfoView">
    <a-descriptions-item>
      ...
      <template v-else>
        <div style="text-align: center">
          <a-avatar :size="100" style="background-color: #3370ff">
            <IconUser />
          </a-avatar>
        </div>
      </template>
    </a-descriptions-item>
    <a-card title="我的信息" style="margin: 0 auto">
    ...
    >
        ...
        >
          <template #upload-button>
            <div class="arco-upload-list-picture custom-upload-avatar">
              ...
              <template v-else>
                <div style="text-align: center">
                  <a-avatar :size="70" style="background-color: #3370ff">
                    <IconUser />
                  </a-avatar>
                </div>
              </template>
      ...
      <a-form
        :model="loginUser as any"
        label-align="right"
        title="个人信息"
        style="max-width: 480px; margin: 0 auto"
      >
        <a-form-item field="用户名称" label="昵称 :">
...
const data = [
  ...
  },
  {
    label: "我的简介：",
    value:
      loginUser.userProfile !== "" ? loginUser.userProfile : "这里什么也没留下",
  },
  {
    label: "用户角色：",
  ...
  {
    label: "邮箱：",
    value: loginUser.email !== null ? loginUser.email : "未填写",
  },
  {
    label: "当前状态：",
    value: loginUser.userState,
  },
